...
/// </summary>
/// <param name="animate" type="Object">动画参数</param>
/// <returns type="twaver.Animate"></returns>
/// <example>
/// 	 new twaver.Animate({
/// 	    from: { x: 100, y: 100 },
/// 	    to: { x: 300, y: 200 },
...
/// </summary>
/// <param name="animate" type="twaver.Animate">要执行的动画</param>
/// <returns type="twaver.Animate">返回动画本身</returns>
/// <example>
/// 	 new twaver.Animate({
/// 	    from: { x: 100, y: 100 },
/// 	    to: { x: 300, y: 200 },
...
/// <returns type="twaver.Alarm"></returns>
}
...
/// 	判断动画是否是暂停状态
/// </summary>
/// <returns type="Boolean">动画的状态</returns>
}
...
/// 	返回动画的进程，即value的值。
/// </summary>
/// <param name="percent" type="Number"></param>
/// <returns type="twaver.Animate"></returns>
}
...
/// </summary>
/// <param name="end" type="String"></param>
/// <returns type="twaver.Animate"></returns>
}
...
/// 	判断网元视图是否和指定区域相交
/// </summary>
/// <param name="r" type="Object">矩形区域，值为包含x、y、width和height属性的Object对象</param>
...
/// <param name="ctx" type="HTMLCanvasElement">画布元素</param>
...
/// 	获取菜单文字颜色
/// </summary>
/// <returns type="String">返回菜单的文字颜色值</returns>
}
...
/// 	获取菜单x轴方向偏移量
/// </summary>
/// <returns type="Number">菜单在x轴方向偏移量</returns>
}
...
/// 	获取菜单y轴方向偏移量
/// </summary>
/// <returns type="String">菜单在y轴方向偏移量</returns>
}
...
/// 	设置菜单文字颜色
/// </summary>
/// <param name="value" type="String">颜色值</param>
}
...
/// 	设置菜单x轴方向偏移量
/// </summary>
/// <param name="value" type="String">菜单在x轴方向偏移量</param>
}
...
/// 	设置菜单y轴方向偏移量
/// </summary>
/// <param name="value" type="String">菜单在y轴方向偏移量</param>
}
...
/// <param name="source" type="String">图片路径</param>
/// <param name="width" type="Number">图片的宽</param>
/// <param name="height" type="Number">图片的高</param>
/// <param name="svg" type="Boolean">是否为SVG格式</param>
...
/// <returns type="Boolean">网元视图中的画布元素是否包含指定坐标，是则返回true，否则返回false</returns>
}
...
/// </summary>
/// <param name="checkAttachments" type="String">检查所有附件是否可见，默认为true</param>
}
...
/// <field type="Boolean">图片是否需要进行序列化。true为序列化，否则为false</field>
}
...
/// 	这个类用于管理Undo和Redo
/// </summary>
/// <param name="box" type="twaver.DataBox">数据容器</param>
/// <returns type="twaver.UndoManager">Undo管理器</returns>
}
...
/// <param name="scope" type="Object">作用域，默认为全局</param>
/// <returns type="twaver.UndoManager">缓存管理器</returns>
}
...
/// 	是否可以重做
/// </summary>
/// <returns type="Boolean">是否可以重做</returns>
}
...
/// 	是否可以取消
/// </summary>
/// <returns type="String">是否可以取消</returns>
}
...
/// 	清空UndoManager
/// </summary>
/// <returns type="twaver.UndoManager">返回UndoManager</returns>
}
...
/// <param name="listener" type="String"></param>
/// <param name="scope" type="String"></param>
}
...
/// <param name="listener" type="String"></param>
/// <param name="scope" type="String"></param>
/// <param name="ahead" type="String"></param>
}
...
/// <param name="enabled" type="String"></param>
}
...
/// <param name="suspended" type="String"></param>
}
...
/// 	缓存的动作数量，即缓存动作列表的长度
/// </summary>
/// <returns type="Number"> 动作数量</returns>
}
...
/// 	获取HSV颜色
/// </summary>
/// <param name="h" type="String"></param>
...
/// 	获取两个网元之间的所有link
/// </summary>
/// <param name="node1" type="twaver.Element">网元</param>
/// <param name="node2" type="twaver.Element">网元</param>
/// <returns type="twaver.List">返回两个网元之间所有link</returns>
}
...
/// <param name="node1" type="twaver.Element">网元</param>
/// <param name="node2" type="twaver.Element">网元</param>
/// <returns type="Boolean">返回两个网元之间是否有连线</returns>
}
...
/// 	高清屏
/// </summary>
/// <param name="c" type="CanvasRenderingContext2D">Canvas</param>
}
...
/// 	暂停动画
/// </summary>
/// <param name="animate" type="twaver.Animate">动画</param>
}
...
/// </summary>
/// <param name="animate" type="twaver.Animate">动画</param>
/// <returns type="twaver.Animate">返回动画</returns>
}
...
/// 	生成16进制随机颜色值
/// </summary>
/// <returns type="String">返回随机颜色</returns>
}
...
/// </summary>
/// <param name="url" type="String">图片地址</param>
/// <param name="name" type="String">图片名称</param>
/// <param name="network" type="String">画布</param>
...
/// 	添加光晕轮廓效果
/// </summary>
/// <param name="part" type="String">添加光晕的部分</param>
/// <param name="rect" type="Boolean">范围</param>
}
...
/// 	清除光晕效果
/// </summary>
/// <param name="ctx" type="String">画布上下文</param>
}
...
/// <param name="force" type="String"></param>
/// <returns type="String"></returns>
}
...
/// 	设置光晕轮廓效果
/// </summary>
/// <param name="part" type="String">网元设置光晕的部分</param>
/// <param name="ctx" type="String">画布上下文</param>
}
...
/// 	显示旋转刻度
/// </summary>
/// <param name="ctx" type="String"></param>
}
...
/// 	获取视图是否自动计算Bounds（边界）
/// </summary>
/// <returns type="Boolean">是否自动调整Bounds</returns>
}
...
/// 	设置视图是否自动计算Bounds
/// </summary>
/// <param name="autoAdjustBounds" type="Boolean">是否自动计算Bounds</param>
}
...
/// <field type="Boolean">IClient标志，默认为true，表明这个对象是IClient类型。</field>
}
...
/// 	获取容器中所有的自定义属性
/// </summary>
/// <returns type="twaver.List">自定义属性集合</returns>
}
...
/// </summary>
/// <param name="type" type="String">数据的类型</param>
...
/// </summary>
/// <returns type="String">返回画线时线条两端的样式</returns>
}
...
/// <param name="points" type="twaver.List">坐标点集合</param>
/// <param name="point" type="Object">点</param>
/// <param name="closed" type="Boolean">是否闭合，默认不闭合</param>
/// <returns type="Number">返回指定点所在的边索引</returns>
}
...
/// <param name="point1" type="Object">线段顶点1</param>
/// <param name="point2" type="Object">线段顶点2</param>
/// <param name="width" type="Number">线段宽度，如为负数将视为0</param>
/// <returns type="Boolean">返回指定点是否在线段上</returns>
}
...
/// <param name="xRadius" type="Number">水平半径，可选，默认值为100</param>
/// <param name="yRadius" type="Number">垂直半径，可选，默认值为100</param>
/// <param name="shape" type="String">放大镜形状，可选，默认值为圆形</param>
/// <returns type="twaver.network.interaction.MagnifyInteraction"></returns>
/// <example>
/// 	network.setInteractions([
/// 	    new twaver.network.interaction.SelectInteraction(network),
...
/// 	获取y轴半径
/// </summary>
/// <returns type="Number">返回y轴半径，默认为100</returns>
}
...
/// <param name="width" type="Number">线条宽度</param>
/// <param name="color" type="String">线条颜色</param>
/// <param name="pattern" type="String">连线样式</param>
}
...
/// </summary>
/// <param name="network" type="twaver.network.Network">拓扑</param>
/// <param name="lazyMode" type="String"></param>
/// <returns type="twaver.network.interaction.DefaultInteraction"></returns>
}
...
/// <param name="ctx" type="String"></param>
/// <param name="fillStyle" type="String"></param>
/// <param name="alpha" type="String"></param>
/// <param name="x" type="String"></param>
/// <param name="y" type="String"></param>
/// <param name="w" type="String"></param>
/// <param name="h" type="String"></param>
/// <param name="r" type="String"></param>
}
...
/// 	获取背景颜色
/// </summary>
/// <returns type="String">颜色</returns>
}
...
/// 	设置缩放比例
/// </summary>
/// <param name="value" type="Number">缩放比例</param>
}
...
/// 	设置形状
/// </summary>
/// <param name="value" type="String">形状</param>
}
...
/// 	设置x半径
/// </summary>
/// <param name="value" type="Number">x半径</param>
}
...
/// 	设置y半径
/// </summary>
/// <param name="value" type="Number">y半径</param>
}
...
/// 	获取link的绝对角度(0-360度)
/// </summary>
/// <returns type="Number">绝对角度</returns>
}
...
/// 	获取link的角度
/// </summary>
/// <returns type="Number">角度</returns>
}
...
/// <field type="Boolean">告警标志，默认为true</field>
}
...
/// </summary>
/// <param name="elementUI" type="twaver.canvas.ElementUI">网元视图</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在最上层，可选，默认为true</param>
...
/// </summary>
/// <param name="network" type="twaver.canvas.Network">拓扑</param>
/// <param name="element" type="twaver.HTMLLink">HTMLLink</param>
/// <returns type="twaver.canvas.HTMLLinkUI"></returns>
}
...
/// </summary>
/// <param name="network" type="twaver.canvas.Network">拓扑</param>
/// <param name="element" type="twaver.HTMLNode">HTMLNode</param>
/// <returns type="twaver.canvas.HTMLNodeUI"></returns>
}
...
/// 	设置附件可见
/// </summary>
/// <param name="visible" type="Boolean">附件是否可见</param>
}
...
/// <returns type="Number">获取附件文本的长度</returns>
}
...
/// 	
/// </summary>
/// <returns type="Number">图标的圆角弧度</returns>
}
...
/// 	获取图例面板上图标的圆角弧度，默认为0
/// </summary>
/// <param name="v" type="Number">图标的圆角弧度</param>
}
...
/// <field type="Boolean">是否为列的标识，默认为true</field>
}
...
/// 	判断当前面板是否展开
/// </summary>
/// <returns type="Boolean">是否展开</returns>
}
...
/// </summary>
/// <returns type="Number">鼠标移至表头列更改表头列大小时的公差值</returns>
}
...
/// 	获取网元是否可移动
/// </summary>
/// <returns type="Boolean">网元是否可移动</returns>
}
...
/// 	获取网元是否可见
/// </summary>
/// <returns type="String">网元是否可见</returns>
}
...
/// 	设置网元是否可移动
/// </summary>
/// <param name="v" type="Boolean">网元 是否可移动</param>
}
...
/// 	设置网元是否可见
/// </summary>
/// <param name="v" type="String">网元是否可见，true为可见</param>
}
...
/// </summary>
/// <returns type="Object">操作缓存管理器</returns>
}
...
/// </summary>
/// <param name="elementUI" type="twaver.network.ElementUI">网元视图</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，可选，默认为true</param>
...
/// <param name="elementUI" type="twaver.network.ElementUI">网元视图</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，可选，默认为false</param>
/// <returns type="twaver.network.HTMLBasicAttachment"></returns>
}
...
/// </summary>
/// <param name="network" type="twaver.network.Network">拓扑</param>
/// <param name="element" type="twaver.HTMLLink">连线</param>
/// <returns type="twaver.network.HTMLLinkUI"></returns>
}
...
/// <param name="network" type="twaver.network.Network">拓扑</param>
/// <param name="element" type="twaver.HTMLNode">HTMLNode</param>
/// <returns type="twaver.network.HTMLNodeUI"></returns>
}
...
/// </summary>
/// <returns type="Number">标签最大长度</returns>
}
...
/// <field type="Object">这个属性项所对应的render的Editor</field>
}
...
/// <field type="Object">这个属性项所对应的render的值</field>
}
...
/// </summary>
/// <param name="network" type="twaver.vector.Network">视图</param>
/// <param name="element" type="twaver.Element">网元</param>
/// <returns type="twaver.vector.HTMLLinkUI">HTMLLink UI</returns>
}
...
/// 	设置附件是否可见
/// </summary>
/// <param name="visible" type="Boolean">是否可见</param>
}
...
/// <param name="network" type="twaver.vector.Network">视图</param>
/// <param name="element" type="twaver.Element">网元</param>
/// <returns type="twaver.vector.HTMLNodeUI">HTMLNode UI</returns>
}
...
/// </summary>
/// <param name="layerIndex" type="Number">索引号</param>
}
...
/// </summary>
/// <param name="network" type="String"></param>
/// <param name="sizeChange" type="String"></param>
...
/// </summary>
/// <param name="elementUI" type="twaver.canvas.ElementUI">网元视图</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，默认为true</param>
/// <returns type="twaver.canvas.HTMLAlarmAttachment"></returns>
}
...
/// <returns type="Object">获取告警附件的div</returns>
}

twaver.canvas.HTMLAlarmAttachment.prototype.setVisibility = function (visibility) {
/// <param name="visibility" type="Boolean">设置当前附件是否可见</param>
}
...
/// </summary>
/// <param name="elementUI" type="String">网元视图</param>
/// <param name="showInAttachmentDiv" type="String">是否显示在最上层，可选，默认为false</param>
/// <returns type="twaver.canvas.HTMLLabelAttachment">返回附件本身</returns>
}
...
/// <returns type="Object">返回附件的div</returns>
}
...
/// 	获取画板的高度
/// </summary>
/// <returns type="Number">画板的高度</returns>
}
...
/// 	获取画板的宽度
/// </summary>
/// <returns type="Number">画板的宽度</returns>
}
...
/// </summary>
/// <returns type="Boolean">是否还原</returns>
}
...
/// </summary>
/// <returns type="Boolean">是否允许X轴进行偏移</returns>
}
...
/// </summary>
/// <returns type="Boolean">是否允许X轴方向缩放</returns>
}
...
/// </summary>
/// <returns type="Boolean">是否允许Y轴方向偏移</returns>
}
...
/// </summary>
/// <returns type="Boolean">是否允许Y轴方向缩放</returns>
}
...
/// <param name="animate" type="Boolean">true为需要动画，false不需要动画，默认值为TWave.Defaults.ZOOM_ANIMATE</param>
}
...
/// <param name="elementUI" type="twaver.network.ElementUI">网元视图</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，可选，默认为true</param>
/// <returns type="twaver.network.HTMLAlarmAttachment"></returns>
}
...
/// <param name="elementUI" type="twaver.network.ElementUI">网元视图</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，可选，默认为false</param>
/// <returns type="twaver.network.HTMLLabelAttachment"></returns>
}
...
/// 	获取节点图片路径
/// </summary>
/// <returns type="String">节点图片路径</returns>
}
...
/// 	设置节点图片路径
/// </summary>
/// <param name="imageUrl" type="String">节点图片路径</param>
}
...
/// </summary>
/// <param name="elementUI" type="twaver.vector.ElementUI">UI</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，可选，默认为true</param>
/// <returns type="twaver.vector.HTMLAlarmAttachment">返回告警附件</returns>
}
...
/// 	设置附件是否可见
/// </summary>
/// <param name="visibility" type="Boolean">是否可见</param>
}
...
/// <param name="elementUI" type="twaver.vector.ElementUI">ui</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，可选，默认为false</param>
/// <returns type="twaver.vector.HTMLLabel2Attachment">label2附件</returns>
}
...
/// 	获取label2附件的div
/// </summary>
/// <returns type="Object">返回label2附件的div</returns>
}
...
/// <param name="elementUI" type="twaver.vector.ElementUI">ui</param>
/// <param name="showInAttachmentDiv" type="Boolean">是否显示在附件层，可选，默认为false</param>
/// <returns type="twaver.vector.HTMLLabelAttachment">label附件</returns>
}
...
/// 	获取指定坐标点或者当前鼠标下的网元
/// </summary>
/// <param name="e" type="Object">可以为坐标点或者鼠标事件</param>
...
/// 	获取和网元关联的视图对象
/// </summary>
/// <param name="data" type="twaver.Element">网元</param>
...
/// </summary>
/// <param name="c" type="Object">网元顺序变化事件，包含element、oldIndex和newIndex属性</param>
}
...
/// </summary>
/// <param name="e" type="Object">鼠标事件或坐标点</param>
...
/// 	获取是否在编辑状态显示阴影
/// </summary>
/// <returns type="Boolean">是否在编辑状态显示阴影</returns>
}
...
/// 	获取网元透明部分是否可选
/// </summary>
/// <returns type="String">网元透明部分是否可选</returns>
}
...
/// </summary>
/// <param name="element" type="twaver.Element">网元</param>
/// <param name="e" type="MouseEvent">事件</param>
}
...
/// 	设置debug模式
/// </summary>
/// <param name="v" type="Boolean">调试</param>
}
...
/// 	设置选择公差大小
/// </summary>
/// <param name="v" type="String">选择公差大小</param>
}
...
/// </summary>
/// <param name="v" type="String">网元透明部分是否可选</param>
}
...
/// </summary>
/// <param name="v" type="Number">起始值显示的角度</param>
}
...
/// 	获取图表上限制的最小值
/// </summary>
/// <returns type="Number">限制最小值</returns>
}
...
/// 	获取图表上网元的最大值
/// </summary>
/// <returns type="Number">最大值</returns>
}
...
/// 	获取图表上网元的最小值
/// </summary>
/// <returns type="Number">最小值</returns>
}
...
/// </summary>
/// <returns type="String">最大、最小值之间的差值</returns>
}
...
/// 	获取最大Span数量
/// </summary>
/// <returns type="Number">最大Span数量</returns>
}
...
/// 	设置图表上限制显示的最小值
/// </summary>
/// <param name="v" type="Number">限制显示的最小值</param>
}
...
/// 	设置图表上限制显示的最大值
/// </summary>
/// <param name="v" type="Number">限制显示的最大值</param>
}
...
/// 	设置最大Span数量
/// </summary>
/// <param name="v" type="String">最大Span数量</param>
}
...
/// 	计算总宽度
/// </summary>
/// <returns type="String">总宽度</returns>
}
...
/// </summary>
/// <param name="params" type="String"></param>
}
...
/// </summary>
/// <param name="params" type="String">编辑状态</param>
}
...
/// <returns type="twaver.HTMLLink"></returns>
}
...
/// </summary>
/// <param name="id" type="String"></param>
/// <returns type="twaver.HTMLNode"></returns>
}
...
/// </summary>
/// <param name="lazyMode" type="Boolean">是否使用延迟模式，可选、默认为false</param>
/// <param name="moveLink" type="String"></param>
}
...
/// 	设置网元透明部分是否可选
/// </summary>
/// <param name="v" type="Boolean">true可选，false不可选</param>
}
...
/// </summary>
/// <param name="oldPoints" type="String"></param>
/// <param name="newPoints" type="String"></param>
}
...
/// </summary>
/// <param name="element" type="twaver.Element">网元</param>
/// <returns type="twaver.vector.Label2Attachment">网元的Label2</returns>
}
...
/// 	获取选中公差
/// </summary>
/// <returns type="Number">选中公差值</returns>
}
...
/// </summary>
/// <param name="ui" type="String"></param>
/// <returns type="Number">节点缩放大小值</returns>
}
...
/// 	获取Network的bounds
/// </summary>
/// <returns type="Object">矩形范围</returns>
}
...
/// </summary>
/// <param name="data" type="twaver.Data">数据对象</param>
/// <returns type="Object">视图范围，是一个包含x、y、witch和height值的对象</returns>
}
...
/// 	是否异步缩放视图尺寸与视图区域
/// </summary>
/// <returns type="Boolean">true则视区不随缩放变化，false则视区大小虽缩放同步变化</returns>
}
...
/// 	获取是否已开启Debug模式
/// </summary>
/// <returns type="Boolean">是否已开启Debug模式</returns>
}
...
/// 	判断是否可以通过拖拽实现Pan的功能
/// </summary>
/// <returns type="Boolean">拖动是否可以Pan</returns>
}
...
/// 	是否启动边缘检测功能
/// </summary>
/// <returns type="Boolean">边缘检测</returns>
}
...
/// </summary>
/// <param name="node" type="twaver.Node">节点</param>
/// <param name="fromNode" type="String"></param>
/// <returns type="Boolean">返回指定节点是否可以创建连线</returns>
}
...
/// </summary>
/// <returns type="Boolean">返回在Zoom或Pan的时候Attachments是否绘制</returns>
}
...
/// </summary>
/// <returns type="Boolean">返回在zoom、Pan、Autolayout情况下是否绘制附件</returns>
}
...
/// 	获取当前附件是否需要显示
/// </summary>
/// <param name="data" type="twaver.vector.Attachment">附件</param>
/// <returns type="Boolean">是否显示</returns>
}
...
/// </summary>
/// <param name="ctx" type="CanvasRenderingContext2D">画布上下文</param>
/// <param name="dirtyRect" type="String"></param>
}
...
/// 	根据污染范围，绘制最上层元素
/// </summary>
/// <param name="ctx" type="String">Canvas上下文</param>
/// <param name="dirtyRect" type="Object">污染范围</param>
}
...
/// </summary>
/// <param name="v" type="Boolean">是否异步，默认为false</param>
}
...
/// 	设置开启Debug模式
/// </summary>
/// <param name="v" type="Boolean">是否开启debug模式</param>
}
...
/// </summary>
/// <param name="v" type="Boolean">Network画布是否可以拖拽，默认为true</param>
/// <example>
...
/// <param name="v" type="Boolean">是否启动边缘检测，默认为false</param>
}
...
/// </summary>
/// <param name="v" type="Number">选择公差值</param>
}
...
/// </summary>
/// <param name="v" type="Boolean">设置在Zoom或Pan情况下附件是否显示</param>
/// <example>
...
/// </summary>
/// <param name="v" type="Boolean">设置在zoom、Pan、Autolayout情况下是否绘制附件</param>
/// <example>
...
/// 	设置编辑状态是否显示阴影
/// </summary>
/// <param name="v" type="Boolean">编辑状态下是否显示阴影</param>
}
...
/// <param name="c" type="HTMLCanvasElement">目标Canvas元素，可选，默认为null，如果为null，则创建新的Canvas元素，否则使用此Canvas元素</param>
/// <param name="zoom" type="String"></param>
/// <param name="dx" type="String"></param>
/// <param name="dy" type="String"></param>
/// <returns type="HTMLCanvasElement">返回Canvas元素</returns>
}
...
/// 	获取连线透明度
/// </summary>
/// <returns type="Number">透明度</returns>
}
...
/// 	获取连线颜色
/// </summary>
/// <returns type="Number">连线颜色</returns>
}
...
/// 	获取连线样式
/// </summary>
/// <returns type="String">连线样式</returns>
}
...
/// 	获取连线厚度
/// </summary>
/// <returns type="Number">连线厚度</returns>
}
...
/// </summary>
/// <returns type="String">连线类型</returns>
}
...
/// </summary>
/// <param name="image" type="twaver.ImageAsset">图片</param>
}
...
/// 	设置联系透明度
/// </summary>
/// <param name="v" type="Number">连线透明度</param>
}
...
/// 	设置连线颜色
/// </summary>
/// <param name="v" type="Number">连线颜色值</param>
}
...
/// 	设置连线样式
/// </summary>
/// <param name="v" type="String">连线样式</param>
}
...
/// 	设置连线厚度
/// </summary>
/// <param name="v" type="Number">连线厚度值</param>
}
...
/// 	设置连线类型
/// </summary>
/// <param name="v" type="String">连线类型</param>
}
...
/// 	设置多边形网元上所有连线段的集合
/// </summary>
/// <param name="value" type="twaver.List">多边形节点上连线段的集合</param>
}
...
/// 	获取线的虚线样式
/// </summary>
/// <returns type="String">虚线</returns>
}
...
/// 	获取线的厚度
/// </summary>
/// <returns type="String">厚度</returns>
}
...
/// 	获取线的类型
/// </summary>
/// <returns type="String">类型</returns>
}
...
/// 	设置线的透明度
/// </summary>
/// <param name="v" type="Number">透明度</param>
}
...
/// 	设置线的颜色
/// </summary>
/// <param name="v" type="String">颜色</param>
}
...
/// 	设置线的虚线样式
/// </summary>
/// <param name="v" type="String">虚线样式</param>
}
...
/// 	设置线的厚度
/// </summary>
/// <param name="v" type="String">厚度</param>
}
...
/// 	设置线的样式
/// </summary>
/// <param name="v" type="String">样式</param>
}
