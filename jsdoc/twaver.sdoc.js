 ...
 * @return {twaver.Animate}
 * @example  new twaver.Animate({
 *     from: { x: 100, y: 100 },
 *     to: { x: 300, y: 200 },
 *     type: 'point',
 *     delay: 1000,
 ...
 *   })).play();
 */
twaver.Animate = function (animate) {}

/**
 * 将参数指定的动画链接到当前动画上，当前动画执行完毕后，会立即执行参数指定的动画，此方法返回当前动画对象。
 * @method twaver.Animate.chain
 * @param {twaver.Animate} animate 要执行的动画
 * @return {twaver.Animate} 返回动画本身
 * @example  new twaver.Animate({
 *     from: { x: 100, y: 100 },
 *     to: { x: 300, y: 200 },
 *     type: 'point',
 ...
 *   })).play();
 */
twaver.Animate.prototype.chain = function (animate) {}

/**
 * @method twaver.Animate.clone
 * @return {twaver.Alarm}
 */
twaver.Animate.prototype.clone = function () {}

/**
 * @method twaver.Animate.getClassName
 * @return {String}
 */
twaver.Animate.prototype.getClassName = function () {}

/**
 * 判断动画是否是暂停状态
 * @method twaver.Animate.isPaused
 * @return {Boolean} 动画的状态
 */
twaver.Animate.prototype.isPaused = function () {}

/**
 * 动画执行后，可以用此方法暂停动画，等同于twaver.Util.pauseAnimate(animate)。
 * @method twaver.Animate.pause
 */
twaver.Animate.prototype.pause = function () {}

/**
 * 返回动画的进程，即value的值。
 * @method twaver.Animate.percent
 * @param {Number} percent 
 * @return {twaver.Animate}
 */
twaver.Animate.prototype.percent = function (percent) {}

/**
 * 通过new twaver.Animate({})构造动画后，动画不会立即执行，可以等需要动画执行时，运行twaver.Animate.prototype.play()或者twaver.Util.playAnimate(animate)语句来执行动画。
 * @method twaver.Animate.play
 * @return {twaver.Animate} 返回动画本身
 */
twaver.Animate.prototype.play = function () {}

/**
 * 动画暂停后，可以用此方法恢复动画执行，等同于twaver.Util.resumeAnimate(animate)。
 * @method twaver.Animate.resume
 */
twaver.Animate.prototype.resume = function () {}

/**
 * 控制动画的速度
 * @method twaver.Animate.speed
 * @param {Number} speed 
 * @return {twaver.Animate}
 * @example animate.speed(0.1);
 */
twaver.Animate.prototype.speed = function (speed) {}

/**
 * 停止动画，end参数控制是否执行到结束状态，也即是否用to值运行onUpdate函数，默认值为true。 如果为end为true，动画会立即执行到结束状态；如果为false，动画会在当前状态停止。
 * @method twaver.Animate.stop
 * @param {String} end 
 * @return {twaver.Animate}
 */
twaver.Animate.prototype.stop = function (end) {}
...
/**
 * 销毁附件
 * @method twaver.canvas.Attachment.dispose
 */
twaver.canvas.Attachment.prototype.dispose = function () {}
...
/**
 * 销毁当前视图
 * @method twaver.canvas.ElementUI.dispose
 */
twaver.canvas.ElementUI.prototype.dispose = function () {}
 ...
 * @param {Object} r 矩形区域，值为包含x、y、width和height属性的Object对象
 * @return {Boolean} 如果网元视图包含指定矩形区域，则返回true，否则返回false
 */
twaver.canvas.ElementUI.prototype.intersects = function (r) {}
 ...
 * @param {HTMLCanvasElement} ctx 画布元素
 * @return {CanvasRenderingContext2D} 画布渲染内容
 */
twaver.canvas.ElementUI.prototype.setShadow = function (part, ctx) {}
...
/**
 * 获取菜单文字颜色
 * @method twaver.controls.PopupMenu.getColor
 * @return {String} 返回菜单的文字颜色值
 */
twaver.controls.PopupMenu.prototype.getColor = function () {}
...
/**
 * 获取菜单项高亮背景颜色
 * @method twaver.controls.PopupMenu.getFocusBackground
 * @return {String} 返回菜单项高亮背景颜色
 */
twaver.controls.PopupMenu.prototype.getFocusBackground = function () {}
...
/**
 * 获取菜单x轴方向偏移量
 * @method twaver.controls.PopupMenu.getXOffset
 * @return {Number} 菜单在x轴方向偏移量
 */
twaver.controls.PopupMenu.prototype.getXOffset = function () {}

/**
 * 获取菜单y轴方向偏移量
 * @method twaver.controls.PopupMenu.getYOffset
 * @return {String} 菜单在y轴方向偏移量
 */
twaver.controls.PopupMenu.prototype.getYOffset = function () {}
...
/**
 * 设置菜单文字颜色
 * @method twaver.controls.PopupMenu.setColor
 * @param {String} value 颜色值
 */
twaver.controls.PopupMenu.prototype.setColor = function (value) {}
...
/**
 * 设置菜单项高亮背景颜色
 * @method twaver.controls.PopupMenu.setFocusBackground
 * @param {String} value 颜色值
 */
twaver.controls.PopupMenu.prototype.setFocusBackground = function (value) {}
...
/**
 * 设置菜单x轴方向偏移量
 * @method twaver.controls.PopupMenu.setXOffset
 * @param {String} value 菜单在x轴方向偏移量
 */
twaver.controls.PopupMenu.prototype.setXOffset = function (value) {}

/**
 * 设置菜单y轴方向偏移量
 * @method twaver.controls.PopupMenu.setYOffset
 * @param {String} value 菜单在y轴方向偏移量
 */
twaver.controls.PopupMenu.prototype.setYOffset = function (value) {}
 ...
 * @return {twaver.ImageAsset}
 */
twaver.ImageAsset.prototype.getImage = function (color, width, height) {}
 ...
 * @return {Boolean} 网元视图中的画布元素是否包含指定坐标，是则返回true，否则返回false
 */
 ...
 * @param {String} [checkAttachments] 检查所有附件是否可见，默认为true
 */
...
/**
 * 图片是否需要进行序列化。true为序列化，否则为false
 * @property isImageSerializable
 * @type Boolean
 * @static
 */
twaver.SerializationSettings.isImageSerializable = function () {}
 ...
 * @constructor
 * @param {twaver.DataBox} box 数据容器
 * @return {twaver.UndoManager} Undo管理器
 */
twaver.UndoManager = function (box) {}

/**
 * 批量进行缓存操作，当进入批量缓存状态时，所有的缓存动作将只被记录，调用endBatch()后再统一执行，这样可提高程序的运行效率
 * @method twaver.UndoManager.batch
 * @param {Function} callback 回调函数
 * @param {Object} [scope] 作用域，默认为全局
 * @return {twaver.UndoManager} 缓存管理器
 */
twaver.UndoManager.prototype.batch = function (callback, scope) {}

/**
 * 是否可以重做
 * @method twaver.UndoManager.canRedo
 * @return {Boolean} 是否可以重做
 */
twaver.UndoManager.prototype.canRedo = function () {}

/**
 * 是否可以取消
 * @method twaver.UndoManager.canUndo
 * @return {String} 是否可以取消
 */
twaver.UndoManager.prototype.canUndo = function () {}

/**
 * 清空UndoManager
 * @method twaver.UndoManager.clear
 * @return {twaver.UndoManager} 返回UndoManager
 */
twaver.UndoManager.prototype.clear = function () {}

/**
 * 结束批量缓存状态，所有的缓存动作立即执行
 * @method twaver.UndoManager.endBatch
 * @return {twaver.UndoManager} 缓存管理器
 */
twaver.UndoManager.prototype.endBatch = function () {}

/**
 * 获取类名
 * @method twaver.UndoManager.getClassName
 * @return {String} 类名
 */
twaver.UndoManager.prototype.getClassName = function () {}

/**
 * @method twaver.UndoManager.getCursor
 * @return {String}
 */
twaver.UndoManager.prototype.getCursor = function () {}

/**
 * @method twaver.UndoManager.getLimit
 * @return {String}
 */
twaver.UndoManager.prototype.getLimit = function () {}

/**
 * @method twaver.UndoManager.isEnabled
 * @return {String}
 */
twaver.UndoManager.prototype.isEnabled = function () {}

/**
 * @method twaver.UndoManager.isSuspended
 * @return {String}
 */
twaver.UndoManager.prototype.isSuspended = function () {}

/**
 * @method twaver.UndoManager.off
 * @param {String} listener 
 * @param {String} scope 
 */
twaver.UndoManager.prototype.off = function (listener, scope) {}

/**
 * @method twaver.UndoManager.on
 * @param {String} listener 
 * @param {String} scope 
 * @param {String} ahead 
 */
twaver.UndoManager.prototype.on = function (listener, scope, ahead) {}

/**
 * 重做，恢复
 * @method twaver.UndoManager.redo
 */
twaver.UndoManager.prototype.redo = function () {}

/**
 * @method twaver.UndoManager.setEnabled
 * @param {String} enabled 
 */
twaver.UndoManager.prototype.setEnabled = function (enabled) {}

/**
 * @method twaver.UndoManager.setLimit
 * @param {String} limit 
 * @return {String}
 */
twaver.UndoManager.prototype.setLimit = function (limit) {}

/**
 * @method twaver.UndoManager.setSuspended
 * @param {String} suspended 
 */
twaver.UndoManager.prototype.setSuspended = function (suspended) {}

/**
 * 缓存的动作数量，即缓存动作列表的长度
 * @method twaver.UndoManager.size
 * @return {Number}  动作数量
 */
twaver.UndoManager.prototype.size = function () {}

/**
 * 开始进入批量缓存状态，所有的缓存动作将只被记录，调用endBatch()后再统一执行
 * @method twaver.UndoManager.startBatch
 * @return {twaver.UndoManager} 缓存管理器
 */
twaver.UndoManager.prototype.startBatch = function () {}

/**
 * 取消，后退
 * @method twaver.UndoManager.undo
 */
twaver.UndoManager.prototype.undo = function () {}
...
/**
 * 获取HSV颜色
 * @method twaver.Util.getHSVColor
 * @param {String} h 
 * @param {String} s 
 * @param {String} v 
 * @return {String}
 * @static
 */
twaver.Util.getHSVColor = function (h, s, v) {}
...
/**
 * 获取TWaver的License
 * @method twaver.Util.getLicense
 * @return {String}
 * @static
 */
twaver.Util.getLicense = function () {}
...
/**
 * 获取两个网元之间的所有link
 * @method twaver.Util.getSharedLinks
 * @param {twaver.Element} node1 网元
 * @param {twaver.Element} node2 网元
 * @return {twaver.List} 返回两个网元之间所有link
 * @static
 */
twaver.Util.getSharedLinks = function (node1, node2) {}
...
/**
 * @method twaver.Util.isPermissionGIS
 * @return {String}
 * @static
 */
twaver.Util.isPermissionGIS = function () {}
...
/**
 * 判断两个网元之间是否有连线
 * @method twaver.Util.isSharedLinks
 * @param {twaver.Element} node1 网元
 * @param {twaver.Element} node2 网元
 * @return {Boolean} 返回两个网元之间是否有连线
 * @static
 */
twaver.Util.isSharedLinks = function (node1, node2) {}
...
/**
 * 高清屏
 * @method twaver.Util.makeHighRes
 * @param {CanvasRenderingContext2D} c Canvas
 * @static
 */
twaver.Util.makeHighRes = function (c) {}
...
/**
 * @method twaver.Util.newFunction
 * @return {String}
 * @static
 */
twaver.Util.newFunction = function () {}
...
/**
 * @method twaver.Util.parseVectorData
 * @param {String} data 
 * @return {String}
 * @static
 */
twaver.Util.parseVectorData = function (data) {}

/**
 * 暂停所有动画
 * @method twaver.Util.pauseAllAnimates
 * @static
 */
twaver.Util.pauseAllAnimates = function () {}

/**
 * 暂停动画
 * @method twaver.Util.pauseAnimate
 * @param {twaver.Animate} animate 动画
 * @static
 */
twaver.Util.pauseAnimate = function (animate) {}

/**
 * 播放动画
 * @method twaver.Util.playAnimate
 * @param {twaver.Animate} animate 动画
 * @return {twaver.Animate} 返回动画
 * @static
 */
twaver.Util.playAnimate = function (animate) {}
...
/**
 * 生成随机数
 * @method twaver.Util.random
 * @return {Number} 随机数
 * @static
 */
twaver.Util.random = function () {}

/**
 * 生成16进制随机颜色值
 * @method twaver.Util.randomColor
 * @return {String} 返回随机颜色
 * @static
 */
twaver.Util.randomColor = function () {}
...
/**
 * 注册Gif动态图片
 * @method twaver.Util.registerGifImage
 * @param {String} name 名称
 * @param {String} url 图片地址
 * @static
 */
twaver.Util.registerGifImage = function (name, url) {}
...
/**
 * 根据URL注册图片资源
 * @method twaver.Util.registerImageByUrl
 * @param {String} url 图片地址
 * @param {String} name 图片名称
 * @param {String} network 画布
 * @param {String} callback 回调函数
 * @static
 */
twaver.Util.registerImageByUrl = function (url, name, network, callback) {}
...
/**
 * 恢复所有暂停
 * @method twaver.Util.resumeAllAnimates
 * @static
 */
twaver.Util.resumeAllAnimates = function () {}

/**
 * 恢复动画
 * @method twaver.Util.resumeAnimate
 * @param {twaver.Animate} animate 动画
 * @static
 */
twaver.Util.resumeAnimate = function (animate) {}
...
/**
 * 停止所有动画
 * @method twaver.Util.stopAllAnimates
 * @param {String} end 
 * @static
 */
twaver.Util.stopAllAnimates = function (end) {}

/**
 * 停止动画
 * @method twaver.Util.stopAnimate
 * @param {twaver.Animate} animate 动画
 * @param {String} end 
 * @static
 */
twaver.Util.stopAnimate = function (animate, end) {}
...
/**
 * @method twaver.Util.toHex
 * @param {String} value 
 * @return {String}
 * @static
 */
twaver.Util.toHex = function (value) {}
...
/**
 * 释放附件
 * @method twaver.vector.Attachment.dispose
 */
twaver.vector.Attachment.prototype.dispose = function () {}
...
/**
 * 添加光晕轮廓效果
 * @method twaver.vector.ElementUI.appendGlowBound
 * @param {String} part 添加光晕的部分
 * @param {Boolean} rect 范围
 */
twaver.vector.ElementUI.prototype.appendGlowBound = function (part, rect) {}
...
/**
 * 清除光晕效果
 * @method twaver.vector.ElementUI.clearGlow
 * @param {String} ctx 画布上下文
 */
twaver.vector.ElementUI.prototype.clearGlow = function (ctx) {}
...
/**
 * @method twaver.vector.ElementUI.dispose
 */
twaver.vector.ElementUI.prototype.dispose = function () {}
...
/**
 * @method twaver.vector.ElementUI.getZoomBodyRect
 * @param {String} force 
 * @return {String}
 */
twaver.vector.ElementUI.prototype.getZoomBodyRect = function (force) {}
...
/**
 * @method twaver.vector.ElementUI.invalidateZoom
 */
twaver.vector.ElementUI.prototype.invalidateZoom = function () {}
...
/**
 * 设置光晕轮廓效果
 * @method twaver.vector.ElementUI.setGlow
 * @param {String} part 网元设置光晕的部分
 * @param {String} ctx 画布上下文
 */
twaver.vector.ElementUI.prototype.setGlow = function (part, ctx) {}
...
twaver.canvas.interaction.CreateElementInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
...
twaver.canvas.interaction.CreateLinkInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
...
twaver.canvas.interaction.CreateShapeNodeInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
...
twaver.canvas.interaction.DefaultInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
...
/**
 * 鼠标移动事件
 * @method twaver.canvas.interaction.DefaultInteraction.handle_mousemove
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.interaction.DefaultInteraction.prototype.handle_mousemove = function (e) {}
...
twaver.canvas.interaction.EditInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
 ...
 * @param {String} ctx 
 */
twaver.canvas.interaction.EditInteraction.prototype.showRotateScale = function (ctx) {}
 ...
 * @extends twaver.canvas.interaction.BaseInteraction
 * @param {twaver.network.Network} network 拓扑
 * @param {Number} [zoom] 缩放比例，可选，默认值为2
...
twaver.canvas.interaction.MagnifyInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
...
twaver.canvas.interaction.MoveInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
...
twaver.canvas.interaction.PanInteraction.prototype = new twaver.canvas.interaction.BaseInteraction()
...
twaver.canvas.LinkUI.prototype = new twaver.canvas.ElementUI()
 ...
 */
twaver.canvas.LinkUI.prototype.drawLinePoints = function (g, points, width, color, pattern) {}
...
/**
 * 获取视图是否自动计算Bounds（边界）
 * @method twaver.controls.ControlBase.isAutoAdjustBounds
 * @return {Boolean} 是否自动调整Bounds
 */
twaver.controls.ControlBase.prototype.isAutoAdjustBounds = function () {}
...
/**
 * 设置视图是否自动计算Bounds
 * @method twaver.controls.ControlBase.setAutoAdjustBounds
 * @param {Boolean} autoAdjustBounds 是否自动计算Bounds
 */
twaver.controls.ControlBase.prototype.setAutoAdjustBounds = function (autoAdjustBounds) {}
...
/**
 * 获取所有的自定义属性
 * @method twaver.Data.getClientMap
 * @return {twaver.List} 自定义属性的集合
 */
twaver.Data.prototype.getClientMap = function () {}
...
/**
 * 往数据容器中添加一个数据及其所有孩子
 * @method twaver.DataBox.addByDescendant
 * @param {twaver.Data} data 数据对象
 */
twaver.DataBox.prototype.addByDescendant = function (data) {}
...
/**
 * 获取容器中所有的自定义属性
 * @method twaver.DataBox.getClientMap
 * @return {twaver.List} 自定义属性集合
 */
twaver.DataBox.prototype.getClientMap = function () {}
 ...
 * @method twaver.DataBox.getRandomData
 * @param {String} [type] 数据的类型
 * @return {twaver.Data}
 */
twaver.DataBox.prototype.getRandomData = function (type) {}
...
/**
 * 鼠标移动事件
 * @method twaver.network.interaction.DefaultInteraction.handle_mousemove
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.interaction.DefaultInteraction.prototype.handle_mousemove = function (e) {}
 ...
 * @param {Object} point1 线段顶点1
 * @param {Object} point2 线段顶点2
 * @param {Number} width 线段宽度，如为负数将视为0
 * @return {Boolean} 返回指定点是否在线段上
 */
 ...
 * @param {Number} [xRadius] 水平半径，可选，默认值为100
 * @param {Number} [yRadius] 垂直半径，可选，默认值为100
 * @param {String} [shape] 放大镜形状，可选，默认值为圆形
 * @return {twaver.network.interaction.MagnifyInteraction}
 * @example network.setInteractions([
 *     new twaver.network.interaction.SelectInteraction(network),
 *     new twaver.network.interaction.MoveInteraction(network),
...
/**
 * 鼠标离开事件
 * @method twaver.network.interaction.MoveInteraction.handle_mouseleave
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.interaction.MoveInteraction.prototype.handle_mouseleave = function (e) {}
 ...
 * @param {Number} width 线条宽度
 * @param {String} color 线条颜色
 * @param {String} pattern 连线样式
 */
twaver.network.LinkUI.prototype.drawLinePoints = function (g, points, width, color, pattern) {}
...
twaver.SelectionModel.prototype = new twaver.PropertyChangeDispatcher()
...
twaver.vector.BasicAttachment.prototype = new twaver.vector.Attachment()
...
twaver.vector.EditAttachment.prototype = new twaver.vector.Attachment()
...
twaver.vector.IconsAttachment.prototype = new twaver.vector.Attachment()
...
twaver.vector.interaction.CreateElementInteraction.prototype = new twaver.vector.interaction.BaseInteraction()
...
twaver.vector.interaction.CreateLinkInteraction.prototype = new twaver.vector.interaction.BaseInteraction()
...
twaver.vector.interaction.CreateShapeNodeInteraction.prototype = new twaver.vector.interaction.BaseInteraction()
...
twaver.vector.interaction.DefaultInteraction.prototype = new twaver.vector.interaction.BaseInteraction()
...
/**
 * 处理键盘弹起事件
 * @method twaver.vector.interaction.DefaultInteraction.handle_keyup
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.interaction.DefaultInteraction.prototype.handle_keyup = function (e) {}
...
/**
 * @method twaver.vector.interaction.DefaultInteraction.handle_mousemove
 * @param {String} e 
 */
twaver.vector.interaction.DefaultInteraction.prototype.handle_mousemove = function (e) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.handle_mouseout
 * @param {String} e 
 */
twaver.vector.interaction.DefaultInteraction.prototype.handle_mouseout = function (e) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.handle_mouseover
 * @param {String} e 
 */
twaver.vector.interaction.DefaultInteraction.prototype.handle_mouseover = function (e) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.handle_mouseup
 * @param {String} e 
 */
twaver.vector.interaction.DefaultInteraction.prototype.handle_mouseup = function (e) {}
...
/**
 * @method twaver.vector.interaction.DefaultInteraction.handleMouseWheel
 * @param {String} e 
 */
twaver.vector.interaction.DefaultInteraction.prototype.handleMouseWheel = function (e) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.handleViewRectChange
 * @param {String} e 
 */
twaver.vector.interaction.DefaultInteraction.prototype.handleViewRectChange = function (e) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.isParenting
 * @return {String}
 */
twaver.vector.interaction.DefaultInteraction.prototype.isParenting = function () {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.paintRoundRect
 * @param {String} ctx 
 ...
 * @param {String} r 
 */
twaver.vector.interaction.DefaultInteraction.prototype.paintRoundRect = function (ctx, fillStyle, alpha, x, y, w, h, r) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.paintScroll
 * @param {String} ctx 
 */
twaver.vector.interaction.DefaultInteraction.prototype.paintScroll = function (ctx) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.parentProcess
 * @param {String} e 
 * @param {String} released 
 */
twaver.vector.interaction.DefaultInteraction.prototype.parentProcess = function (e, released) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.scrollXOffset
 * @param {String} left 
 */
twaver.vector.interaction.DefaultInteraction.prototype.scrollXOffset = function (left) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.scrollYOffset
 * @param {String} up 
 */
twaver.vector.interaction.DefaultInteraction.prototype.scrollYOffset = function (up) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.start
 * @param {String} e 
 */
twaver.vector.interaction.DefaultInteraction.prototype.start = function (e) {}

/**
 * @method twaver.vector.interaction.DefaultInteraction.validateScrollBar
 */
twaver.vector.interaction.DefaultInteraction.prototype.validateScrollBar = function () {}
...
twaver.vector.interaction.EditInteraction.prototype = new twaver.vector.interaction.BaseInteraction()
...
twaver.vector.interaction.MagnifyInteraction.prototype = new twaver.vector.interaction.BaseInteraction()

/**
 * 获取背景颜色
 * @method twaver.vector.interaction.MagnifyInteraction.getBackgroundColor
 * @return {String} 颜色
 */
twaver.vector.interaction.MagnifyInteraction.prototype.getBackgroundColor = function () {}

/**
 * 获取边界颜色
 * @method twaver.vector.interaction.MagnifyInteraction.getBorderColor
 * @return {String} 颜色
 */
twaver.vector.interaction.MagnifyInteraction.prototype.getBorderColor = function () {}

/**
 * 获取边界宽度
 * @method twaver.vector.interaction.MagnifyInteraction.getBorderWidth
 * @return {Number} 宽度
 */
twaver.vector.interaction.MagnifyInteraction.prototype.getBorderWidth = function () {}

/**
 * 获取缩放比例
 * @method twaver.vector.interaction.MagnifyInteraction.getScale
 * @return {Number} 缩放比例
 */
twaver.vector.interaction.MagnifyInteraction.prototype.getScale = function () {}

/**
 * @method twaver.vector.interaction.MagnifyInteraction.getShape
 * @return {String} 形状
 */
twaver.vector.interaction.MagnifyInteraction.prototype.getShape = function () {}

/**
 * @method twaver.vector.interaction.MagnifyInteraction.getXRadius
 * @return {Number} x半径
 */
twaver.vector.interaction.MagnifyInteraction.prototype.getXRadius = function () {}

/**
 * @method twaver.vector.interaction.MagnifyInteraction.getYRadius
 * @return {Number} y半径
 */
twaver.vector.interaction.MagnifyInteraction.prototype.getYRadius = function () {}
...
/**
 * @method twaver.vector.interaction.MagnifyInteraction.handle_mousewheel
 * @param {String} e 
 */
twaver.vector.interaction.MagnifyInteraction.prototype.handle_mousewheel = function (e) {}

/**
 * 设置背景颜色
 * @method twaver.vector.interaction.MagnifyInteraction.setBackgroundColor
 * @param {String} value 颜色
 */
twaver.vector.interaction.MagnifyInteraction.prototype.setBackgroundColor = function (value) {}

/**
 * 设置边界颜色
 * @method twaver.vector.interaction.MagnifyInteraction.setBorderColor
 * @param {String} value 颜色
 */
twaver.vector.interaction.MagnifyInteraction.prototype.setBorderColor = function (value) {}

/**
 * 设置边界宽度
 * @method twaver.vector.interaction.MagnifyInteraction.setBorderWidth
 * @param {Number} value 宽度
 */
twaver.vector.interaction.MagnifyInteraction.prototype.setBorderWidth = function (value) {}

/**
 * 设置缩放比例
 * @method twaver.vector.interaction.MagnifyInteraction.setScale
 * @param {Number} value 缩放比例
 */
twaver.vector.interaction.MagnifyInteraction.prototype.setScale = function (value) {}

/**
 * 设置形状
 * @method twaver.vector.interaction.MagnifyInteraction.setShape
 * @param {String} value 形状
 */
twaver.vector.interaction.MagnifyInteraction.prototype.setShape = function (value) {}

/**
 * 设置x半径
 * @method twaver.vector.interaction.MagnifyInteraction.setXRadius
 * @param {Number} value x半径
 */
twaver.vector.interaction.MagnifyInteraction.prototype.setXRadius = function (value) {}

/**
 * 设置y半径
 * @method twaver.vector.interaction.MagnifyInteraction.setYRadius
 * @param {Number} value y半径
 */
twaver.vector.interaction.MagnifyInteraction.prototype.setYRadius = function (value) {}
...
twaver.vector.interaction.MSTouchInteraction.prototype = new twaver.vector.interaction.BaseInteraction()
...
twaver.vector.interaction.TouchInteraction.prototype = new twaver.vector.interaction.BaseInteraction()
...
twaver.vector.LinkUI.prototype = new twaver.vector.ElementUI()
...
/**
 * 获取link的绝对角度(0-360度)
 * @method twaver.vector.LinkUI.getAbsoluteAngle
 * @return {Number} 绝对角度
 */
twaver.vector.LinkUI.prototype.getAbsoluteAngle = function () {}

/**
 * 获取link的角度
 * @method twaver.vector.LinkUI.getAngle
 * @return {Number} 角度
 */
twaver.vector.LinkUI.prototype.getAngle = function () {}
...
twaver.vector.NodeUI.prototype = new twaver.vector.ElementUI()
...
/**
 * 获取指令类型prefix所占的边框矩形
 * @method twaver.vector.NodeUI.getZoomPathRect
 * @param {String} prefix 前缀
 * @param {Number} padding 边距
 * @return {Object} 矩形
 */
twaver.vector.NodeUI.prototype.getZoomPathRect = function (prefix, padding) {}
 ...
 * @param {twaver.canvas.ElementUI} elementUI 网元视图
 * @param {Boolean} [showInAttachmentDiv] 是否显示在最上层，可选，默认为true
 ...
 * @class twaver.canvas.HTMLLinkUI
 * @constructor
 * @extends twaver.canvas.LinkUI
 * @param {twaver.canvas.Network} network 拓扑
 * @param {twaver.HTMLLink} element HTMLLink
 * @return {twaver.canvas.HTMLLinkUI}
 */
twaver.canvas.HTMLLinkUI = function (network, element) {}

twaver.canvas.HTMLLinkUI.prototype = new twaver.canvas.LinkUI()
 ...
 * @extends twaver.canvas.NodeUI
 * @param {twaver.canvas.Network} network 拓扑
 * @param {twaver.HTMLNode} element HTMLNode
 * @return {twaver.canvas.HTMLNodeUI}
 */
twaver.canvas.HTMLNodeUI = function (network, element) {}

twaver.canvas.HTMLNodeUI.prototype = new twaver.canvas.NodeUI()

/**
 * 设置附件可见
 * @method twaver.canvas.HTMLNodeUI.setAttachmentVisible
 * @param {Boolean} visible 附件是否可见
 */
twaver.canvas.HTMLNodeUI.prototype.setAttachmentVisible = function (visible) {}
...
twaver.canvas.interaction.CreateShapeLinkInteraction.prototype = new twaver.canvas.interaction.CreateLinkInteraction()
...
/**
 * @method twaver.canvas.LabelAttachment.getMaxLength
 * @return {Number} 获取附件文本的长度
 */
twaver.canvas.LabelAttachment.prototype.getMaxLength = function () {}
...
/**
 * 获取下面展开图标
 * @method twaver.controls.SplitPane.getDownExpandIcon
 * @return {String} 图标名称
 */
twaver.controls.SplitPane.prototype.getDownExpandIcon = function () {}
...
/**
 * 获取左侧展开图标
 * @method twaver.controls.SplitPane.getLeftExpandIcon
 * @return {String} 图标名称
 */
twaver.controls.SplitPane.prototype.getLeftExpandIcon = function () {}
...
/**
 * 获取右侧展开图标
 * @method twaver.controls.SplitPane.getRightExpandIcon
 * @return {String} 图标名称
 */
twaver.controls.SplitPane.prototype.getRightExpandIcon = function () {}

/**
 * 获取上方展开图标
 * @method twaver.controls.SplitPane.getUpExpandIcon
 * @return {String} 图标名称
 */
twaver.controls.SplitPane.prototype.getUpExpandIcon = function () {}
...
/**
 * 判断当前面板是否展开
 * @method twaver.controls.SplitPane.isExpandable
 * @return {Boolean} 是否展开
 */
twaver.controls.SplitPane.prototype.isExpandable = function () {}
...
/**
 * 设置下方展开图标
 * @method twaver.controls.SplitPane.setDownExpandIcon
 * @param {String} v 图标名称
 */
twaver.controls.SplitPane.prototype.setDownExpandIcon = function (v) {}

/**
 * 设置是否展开
 * @method twaver.controls.SplitPane.setExpandable
 * @param {String} v 图标名称
 */
twaver.controls.SplitPane.prototype.setExpandable = function (v) {}
...
/**
 * 设置左侧展开图标
 * @method twaver.controls.SplitPane.setLeftExpandIcon
 * @param {String} v 图标名称
 */
twaver.controls.SplitPane.prototype.setLeftExpandIcon = function (v) {}
...
/**
 * 设置右侧展开图标
 * @method twaver.controls.SplitPane.setRightExpandIcon
 * @param {String} v 图标名称
 */
twaver.controls.SplitPane.prototype.setRightExpandIcon = function (v) {}

/**
 * 设置上方展开图标
 * @method twaver.controls.SplitPane.setUpExpandIcon
 * @param {String} v 图标名称
 */
twaver.controls.SplitPane.prototype.setUpExpandIcon = function (v) {}
 ...
 * @return {Number} 鼠标移至表头列更改表头列大小时的公差值
 */
 ...
 * @example var tabPane = new TabPane();
...
/**
 * 获取网元是否可移动
 * @method twaver.Element.isMovable
 * @return {Boolean} 网元是否可移动
 */
twaver.Element.prototype.isMovable = function () {}
...
/**
 * 获取网元是否可见
 * @method twaver.Element.isVisible
 * @return {String} 网元是否可见
 */
twaver.Element.prototype.isVisible = function () {}
...
/**
 * 设置网元是否可移动
 * @method twaver.Element.setMovable
 * @param {Boolean} v 网元 是否可移动
 */
twaver.Element.prototype.setMovable = function (v) {}
...
/**
 * 设置网元是否可见
 * @method twaver.Element.setVisible
 * @param {String} v 网元是否可见，true为可见
 */
twaver.Element.prototype.setVisible = function (v) {}
...
/**
 * 获取操作缓存管理器，可以进行撤销、恢复等操作
 * @method twaver.ElementBox.getUndoManager
 * @return {Object} 操作缓存管理器
 */
twaver.ElementBox.prototype.getUndoManager = function () {}
 ...
 * @param {twaver.network.ElementUI} elementUI 网元视图
 * @param {Boolean} [showInAttachmentDiv] 是否显示在附件层，可选，默认为true
 ...
 * @class twaver.network.HTMLBasicAttachment
 * @constructor
 * @extends twaver.network.BasicAttachment
 * @param {twaver.network.ElementUI} elementUI 网元视图
 * @param {Boolean} [showInAttachmentDiv] 是否显示在附件层，可选，默认为false
 * @return {twaver.network.HTMLBasicAttachment}
 */
twaver.network.HTMLBasicAttachment = function (elementUI, showInAttachmentDiv) {}

twaver.network.HTMLBasicAttachment.prototype = new twaver.network.BasicAttachment()
 ...
 * @class twaver.network.HTMLLinkUI
 * @constructor
 * @extends twaver.network.LinkUI
 * @param {twaver.network.Network} network 拓扑
 * @param {twaver.HTMLLink} element 连线
 * @return {twaver.network.HTMLLinkUI}
 */
twaver.network.HTMLLinkUI = function (network, element) {}

twaver.network.HTMLLinkUI.prototype = new twaver.network.LinkUI()
 ...
 * @class twaver.network.HTMLNodeUI
 * @constructor
 * @extends twaver.network.NodeUI
 * @param {twaver.network.Network} network 拓扑
 * @param {twaver.HTMLNode} element HTMLNode
...
twaver.network.HTMLNodeUI.prototype = new twaver.network.NodeUI()
 ...
 * @method twaver.network.LabelAttachment.getMaxLength
 * @return {Number} 标签最大长度
 */
twaver.network.LabelAttachment.prototype.getMaxLength = function () {}
 ...
 * @property renderEditor
 * @type Object
 */
twaver.Property.prototype.renderEditor = function () {}
...
twaver.vector.AlarmAttachment.prototype = new twaver.vector.BasicAttachment()
...
twaver.vector.GridUI.prototype = new twaver.vector.NodeUI()
...
twaver.vector.GroupUI.prototype = new twaver.vector.NodeUI()
 ...
 * @param {twaver.vector.Network} network 视图
 * @param {twaver.Element} element 网元
 * @return {twaver.vector.HTMLLinkUI} HTMLLink UI
 */
twaver.vector.HTMLLinkUI = function (network, element) {}

twaver.vector.HTMLLinkUI.prototype = new twaver.vector.LinkUI()

/**
 * 设置附件是否可见
 * @method twaver.vector.HTMLLinkUI.setAttachmentVisible
 * @param {Boolean} visible 是否可见
 */
twaver.vector.HTMLLinkUI.prototype.setAttachmentVisible = function (visible) {}
 ...
 * @param {twaver.vector.Network} network 视图
 * @param {twaver.Element} element 网元
 * @return {twaver.vector.HTMLNodeUI} HTMLNode UI
 */
twaver.vector.HTMLNodeUI = function (network, element) {}

twaver.vector.HTMLNodeUI.prototype = new twaver.vector.NodeUI()

/**
 * 设置附件是否可见
 * @method twaver.vector.HTMLNodeUI.setAttachmentVisible
 * @param {Boolean} visible 是否可见
 */
twaver.vector.HTMLNodeUI.prototype.setAttachmentVisible = function (visible) {}

/**
 * 根据索引号设置当前div的zIndex属性
 * @method twaver.vector.HTMLNodeUI.validateZIndex
 * @param {Number} layerIndex 索引号
 */
twaver.vector.HTMLNodeUI.prototype.validateZIndex = function (layerIndex) {}
...
twaver.vector.interaction.CreateShapeLinkInteraction.prototype = new twaver.vector.interaction.CreateLinkInteraction()
...
twaver.vector.RotatableNodeUI.prototype = new twaver.vector.NodeUI()
...
twaver.vector.ShapeLinkUI.prototype = new twaver.vector.LinkUI()
...
twaver.vector.ShapeNodeUI.prototype = new twaver.vector.NodeUI()
 ...
 * @param {twaver.canvas.ElementUI} elementUI 网元视图
 * @param {Boolean} [showInAttachmentDiv] 是否显示在附件层，默认为true
 * @return {twaver.canvas.HTMLAlarmAttachment}
 */
twaver.canvas.HTMLAlarmAttachment = function (elementUI, showInAttachmentDiv) {}

twaver.canvas.HTMLAlarmAttachment.prototype = new twaver.canvas.AlarmAttachment()

/**
 * @method twaver.canvas.HTMLAlarmAttachment.getView
 * @return {Object} 获取告警附件的div
 */
twaver.canvas.HTMLAlarmAttachment.prototype.getView = function () {}

/**
 * @method twaver.canvas.HTMLAlarmAttachment.setVisibility
 * @param {Boolean} visibility 设置当前附件是否可见
 */
twaver.canvas.HTMLAlarmAttachment.prototype.setVisibility = function (visibility) {}
 ...
 * @param {String} elementUI 网元视图
 * @param {String} [showInAttachmentDiv] 是否显示在最上层，可选，默认为false
 * @return {twaver.canvas.HTMLLabelAttachment} 返回附件本身
 */
twaver.canvas.HTMLLabelAttachment = function (elementUI, showInAttachmentDiv) {}

twaver.canvas.HTMLLabelAttachment.prototype = new twaver.canvas.LabelAttachment()

/**
 * @method twaver.canvas.HTMLLabelAttachment.getView
 * @return {Object} 返回附件的div
 */
twaver.canvas.HTMLLabelAttachment.prototype.getView = function () {}

/**
 * @method twaver.canvas.HTMLLabelAttachment.setVisibility
 * @param {Boolean} visibility 设置当前附件是否可见
 */
twaver.canvas.HTMLLabelAttachment.prototype.setVisibility = function (visibility) {}
 ...
 * @param {Boolean} [animate] true为需要动画，false不需要动画，默认值为TWave.Defaults.ZOOM_ANIMATE
 */
 ...
 * @class twaver.network.HTMLAlarmAttachment
 * @constructor
 * @extends twaver.network.AlarmAttachment
 * @param {twaver.network.ElementUI} elementUI 网元视图
 * @param {Boolean} [showInAttachmentDiv] 是否显示在附件层，可选，默认为true
 * @return {twaver.network.HTMLAlarmAttachment}
 */
twaver.network.HTMLAlarmAttachment = function (elementUI, showInAttachmentDiv) {}

twaver.network.HTMLAlarmAttachment.prototype = new twaver.network.AlarmAttachment()
 ...
 * @class twaver.network.HTMLLabelAttachment
 * @constructor
 * @extends twaver.network.LabelAttachment
 * @param {twaver.network.ElementUI} elementUI 网元视图
 * @param {Boolean} [showInAttachmentDiv] 是否显示在附件层，可选，默认为false
 * @return {twaver.network.HTMLLabelAttachment}
 */
twaver.network.HTMLLabelAttachment = function (elementUI, showInAttachmentDiv) {}

twaver.network.HTMLLabelAttachment.prototype = new twaver.network.LabelAttachment()
...
/**
 * 获取节点图片路径
 * @method twaver.Node.getImageUrl
 * @return {String} 节点图片路径
 */
twaver.Node.prototype.getImageUrl = function () {}
...
/**
 * 设置节点图片路径
 * @method twaver.Node.setImageUrl
 * @param {String} imageUrl 节点图片路径
 */
twaver.Node.prototype.setImageUrl = function (imageUrl) {}
 ...
 * @param {twaver.vector.ElementUI} elementUI UI
 * @param {Boolean} [showInAttachmentDiv] 是否显示在附件层，可选，默认为true
 * @return {twaver.vector.HTMLAlarmAttachment} 返回告警附件
 */
twaver.vector.HTMLAlarmAttachment = function (elementUI, showInAttachmentDiv) {}

twaver.vector.HTMLAlarmAttachment.prototype = new twaver.vector.AlarmAttachment()

/**
 * 获取附件的div
 * @method twaver.vector.HTMLAlarmAttachment.getView
 * @return {Object} 返回附件的div
 */
twaver.vector.HTMLAlarmAttachment.prototype.getView = function () {}

/**
 * 设置附件是否可见
 * @method twaver.vector.HTMLAlarmAttachment.setVisibility
 * @param {Boolean} visibility 是否可见
 */
twaver.vector.HTMLAlarmAttachment.prototype.setVisibility = function (visibility) {}
 ...
 * @param {twaver.vector.ElementUI} elementUI ui
 * @param {Boolean} showInAttachmentDiv 是否显示在附件层，可选，默认为false
 * @return {twaver.vector.HTMLLabel2Attachment} label2附件
 */
twaver.vector.HTMLLabel2Attachment = function (elementUI, showInAttachmentDiv) {}

twaver.vector.HTMLLabel2Attachment.prototype = new twaver.vector.LabelAttachment()

/**
 * 获取label2附件的div
 * @method twaver.vector.HTMLLabel2Attachment.getView
 * @return {Object} 返回label2附件的div
 */
twaver.vector.HTMLLabel2Attachment.prototype.getView = function () {}

/**
 * 设置附件是否可见
 * @method twaver.vector.HTMLLabel2Attachment.setVisibility
 * @param {Boolean} visibility 是否可见
 */
twaver.vector.HTMLLabel2Attachment.prototype.setVisibility = function (visibility) {}

/**
 * 根据索引号设置当前div的zIndex属性
 * @method twaver.vector.HTMLLabel2Attachment.validateZIndex
 * @param {Number} layerIndex 索引号
 */
twaver.vector.HTMLLabel2Attachment.prototype.validateZIndex = function (layerIndex) {}
 ...
 * @param {twaver.vector.ElementUI} elementUI ui
 * @param {Boolean} showInAttachmentDiv 是否显示在附件层，可选，默认为false
 * @return {twaver.vector.HTMLLabelAttachment} label附件
 */
twaver.vector.HTMLLabelAttachment = function (elementUI, showInAttachmentDiv) {}

twaver.vector.HTMLLabelAttachment.prototype = new twaver.vector.LabelAttachment()

/**
 * 获取label附件的div
 * @method twaver.vector.HTMLLabelAttachment.getView
 * @return {Object} 返回label2附件的div
 */
twaver.vector.HTMLLabelAttachment.prototype.getView = function () {}

/**
 * 设置当前附件是否可见
 * @method twaver.vector.HTMLLabelAttachment.setVisibility
 * @param {Boolean} visibility 是否可见
 */
twaver.vector.HTMLLabelAttachment.prototype.setVisibility = function (visibility) {}

/**
 * 根据索引号设置当前div的zIndex属性
 * @method twaver.vector.HTMLLabelAttachment.validateZIndex
 * @param {Number} layerIndex 索引号
 */
twaver.vector.HTMLLabelAttachment.prototype.validateZIndex = function (layerIndex) {}
 ...
 */
twaver.canvas.Network.prototype.createElementUI = function (data) {}
 ...
 * });
 */
twaver.canvas.Network.prototype.getElementAt = function (e, selectable) {}
 ...
 * @param {twaver.Element} data 网元
 * @return {twaver.network.ElementUI} 返回和网元关联的视图对象
 */
twaver.canvas.Network.prototype.getElementUI = function (data) {}
...
/**
 * 获取选择模型，如果ViewBase#isShareSelectionModel为true（默认值为true），则返回和ViewBase绑定的DataBox的SelectionModel，否则返回视图自己独立的SelectionModel
 * @method twaver.canvas.Network.getSelectionTolerance
 * @return {twaver.SelectionModel} 返回选择模型
 */
twaver.canvas.Network.prototype.getSelectionTolerance = function () {}
 ...
 */
twaver.canvas.Network.prototype.handleElementBoxPropertyChange = function () {}
 ...
 * @param {Object} c 网元顺序变化事件，包含element、oldIndex和newIndex属性
 */
twaver.canvas.Network.prototype.handleIndexChange = function (c) {}

/**
 * ElementBox的LayerBox里Layer添加、删除以及清空时的处理函数，用户不需要调用此方法，但可以重载此方法，添加自定义逻辑
 * @method twaver.canvas.Network.handleLayerBoxChange
 */
twaver.canvas.Network.prototype.handleLayerBoxChange = function () {}

/**
 * ElementBox的LayerBox里Layer层次变化时的处理函数，用户不需要调用此方法，但可以重载此方法，添加自定义逻辑
 * @method twaver.canvas.Network.handleLayerHierarchyChange
 */
twaver.canvas.Network.prototype.handleLayerHierarchyChange = function () {}
 ...
 * @param {Object} e 鼠标事件或坐标点
 * @return {Object} 返回鼠标下或指定坐标下的网元视图对象或附件对象
 */
twaver.canvas.Network.prototype.hitTest = function (e) {}
...
/**
 * 开启debug模式
 * @method twaver.canvas.Network.isDebug
 * @return {Boolean}
 */
twaver.canvas.Network.prototype.isDebug = function () {}
...
/**
 * 获取是否在编辑状态显示阴影
 * @method twaver.canvas.Network.isShowShadowInEdit
 * @return {Boolean} 是否在编辑状态显示阴影
 */
twaver.canvas.Network.prototype.isShowShadowInEdit = function () {}
...
/**
 * 获取网元透明部分是否可选
 * @method twaver.canvas.Network.isTransparentSelectionEnable
 * @return {String} 网元透明部分是否可选
 */
twaver.canvas.Network.prototype.isTransparentSelectionEnable = function () {}
 ...
 * @return {Boolean} 如果指定网元可见，则返回true，否则返回false
 */
twaver.canvas.Network.prototype.isVisible = function (element, visibleFunction, defaultLayer) {}
...
/**
 * 点击画布背景事件
 * @method twaver.canvas.Network.onClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onClickBackground = function (e) {}

/**
 * 点击网元监听事件
 * @method twaver.canvas.Network.onClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onClickElement = function (element, e) {}

/**
 * 双击画布背景事件
 * @method twaver.canvas.Network.onDoubleClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onDoubleClickBackground = function (e) {}

/**
 * 双击网元的监听事件
 * @method twaver.canvas.Network.onDoubleClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onDoubleClickElement = function (element, e) {}

/**
 * 长按背景监听事件
 * @method twaver.canvas.Network.onLongClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onLongClickBackground = function (e) {}

/**
 * 长按网元监听事件
 * @method twaver.canvas.Network.onLongClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onLongClickElement = function (element, e) {}

/**
 * 进入网元监听事件
 * @method twaver.canvas.Network.onMouseEnter
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onMouseEnter = function (element, e) {}

/**
 * 离开网元监听事件
 * @method twaver.canvas.Network.onMouseLeave
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 事件
 */
twaver.canvas.Network.prototype.onMouseLeave = function (element, e) {}

/**
 * 离开网元监听事件
 * @method twaver.canvas.Network.onMouseMove
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.canvas.Network.prototype.onMouseMove = function (element, e) {}
...
/**
 * 设置debug模式
 * @method twaver.canvas.Network.setDebug
 * @param {Boolean} v 调试
 */
twaver.canvas.Network.prototype.setDebug = function (v) {}
...
/**
 * 设置选择公差大小
 * @method twaver.canvas.Network.setSelectionTolerance
 * @param {String} v 选择公差大小
 */
twaver.canvas.Network.prototype.setSelectionTolerance = function (v) {}
...
/**
 * @method twaver.canvas.Network.setShowShadowInEdit
 * @param {Boolean} v 
 */
twaver.canvas.Network.prototype.setShowShadowInEdit = function (v) {}
 ...
 * @method twaver.canvas.Network.setTransparentSelectionEnable
 * @param {String} v 网元透明部分是否可选
 */
twaver.canvas.Network.prototype.setTransparentSelectionEnable = function (v) {}
...
/**
 * 获取最大Span数量
 * @method twaver.charts.ScaleChart.getValueSpanCount
 * @return {Number} 最大Span数量
 */
twaver.charts.ScaleChart.prototype.getValueSpanCount = function () {}
 ...
 * @param {Number} v 限制显示的最大值
 */
twaver.charts.ScaleChart.prototype.setUpperLimit = function (v) {}

/**
 * 设置最大Span数量
 * @method twaver.charts.ScaleChart.setValueSpanCount
 * @param {String} v 最大Span数量
 */
twaver.charts.ScaleChart.prototype.setValueSpanCount = function (v) {}
...
/**
 * 计算总宽度
 * @method twaver.controls.ListBase.calculateSumWidth
 * @return {String} 总宽度
 */
twaver.controls.ListBase.prototype.calculateSumWidth = function () {}
 ...
 * @method twaver.controls.PropertySheet.onEditorRendered
 * @param {String} params 
 */
twaver.controls.PropertySheet.prototype.onEditorRendered = function (params) {}
 ...
 * @method twaver.controls.PropertySheet.renderEditor
 * @param {String} params 编辑状态
 */
twaver.controls.PropertySheet.prototype.renderEditor = function (params) {}
 ...
 * 
 * HTMLLink，用于呈现HTML元素
 * @class twaver.HTMLLink
 * @constructor
 * @extends twaver.Link
 * @param {String} id 
 * @param {String} from 
 * @param {String} to 
 * @return {twaver.HTMLLink}
 */
twaver.HTMLLink = function (id, from, to) {}

twaver.HTMLLink.prototype = new twaver.Link()
 ...
 * @class twaver.HTMLNode
 * @constructor
 * @extends twaver.Node
 * @param {String} id 
 * @return {twaver.HTMLNode}
 */
twaver.HTMLNode = function (id) {}

twaver.HTMLNode.prototype = new twaver.Node()
...
/**
 * 销毁
 * @method twaver.network.Network.dispose
 */
twaver.network.Network.prototype.dispose = function () {}
...
/**
 * @method twaver.network.Network.isTransparentSelectionEnable
 * @return {String}
 */
twaver.network.Network.prototype.isTransparentSelectionEnable = function () {}
...
/**
 * 点击画布背景鼠标监听事件
 * @method twaver.network.Network.onClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onClickBackground = function (e) {}

/**
 * 点击网元鼠标监听事件
 * @method twaver.network.Network.onClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onClickElement = function (element, e) {}

/**
 * 双击背景鼠标监听事件
 * @method twaver.network.Network.onDoubleClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onDoubleClickBackground = function (e) {}

/**
 * 双击网元鼠标监听事件
 * @method twaver.network.Network.onDoubleClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onDoubleClickElement = function (element, e) {}

/**
 * 长按背景鼠标监听事件
 * @method twaver.network.Network.onLongClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onLongClickBackground = function (e) {}

/**
 * 长按网元鼠标监听事件
 * @method twaver.network.Network.onLongClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onLongClickElement = function (element, e) {}

/**
 * 进入网元鼠标监听事件
 * @method twaver.network.Network.onMouseEnter
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onMouseEnter = function (element, e) {}

/**
 * 离开网元鼠标监听事件
 * @method twaver.network.Network.onMouseLeave
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onMouseLeave = function (element, e) {}

/**
 * 在网元上移动监听事件
 * @method twaver.network.Network.onMouseMove
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.network.Network.prototype.onMouseMove = function (element, e) {}
 ...
 * @param {Boolean} [lazyMode] 是否使用延迟模式，可选、默认为false
 * @param {String} moveLink 
 */
twaver.network.Network.prototype.setDefaultInteractions = function (lazyMode, moveLink) {}
 ...
 * @param {String} moveLink 
 */
twaver.network.Network.prototype.setEditInteractions = function (lazyMode, moveLink) {}
...
/**
 * 设置网元透明部分是否可选
 * @method twaver.network.Network.setTransparentSelectionEnable
 * @param {Boolean} v true可选，false不可选
 */
twaver.network.Network.prototype.setTransparentSelectionEnable = function (v) {}
 ...
 * @param {String} oldPoints 
 * @param {String} newPoints 
 */
twaver.ShapeLink.prototype.firePointsChange = function (oldPoints, newPoints) {}
...
/**
 * 调整Link的顺序，network内部调用
 * @method twaver.vector.Network.adjustLinkIndex
 */
twaver.vector.Network.prototype.adjustLinkIndex = function () {}
...
/**
 * 释放资源
 * @method twaver.vector.Network.dispose
 */
twaver.vector.Network.prototype.dispose = function () {}
 ...
 * });
 */
twaver.vector.Network.prototype.getElementAt = function (e) {}
 ...
 * @return {twaver.network.ElementUI} 返回和网元关联的视图对象
 */
twaver.vector.Network.prototype.getElementUI = function (data) {}
 ...
 * @param {twaver.Element} element 网元
 * @return {twaver.vector.Label2Attachment} 网元的Label2
 */
...
/**
 * 根据鼠标点获取局部坐标点
 * @method twaver.vector.Network.getLogicalPoint2
 * @param {MouseEvent} e 鼠标事件
 * @return {Object} 点
 */
twaver.vector.Network.prototype.getLogicalPoint2 = function (e) {}
 ...
 * bottomright.bottomright
 */
twaver.vector.Network.prototype.getPosition = function (position, obj, tarSize, xoffset, yoffset, zoom) {}
...
/**
 * 获取选中公差
 * @method twaver.vector.Network.getSelectionTolerance
 * @return {Number} 选中公差值
 */
twaver.vector.Network.prototype.getSelectionTolerance = function () {}
...
/**
 * 获取节点缩放大小，这是一个接口函数，可以定制节点的Size随zoom的变化
 * @method twaver.vector.Network.getSizeZoom
 * @param {String} ui 
 * @return {Number} 节点缩放大小值
 */
twaver.vector.Network.prototype.getSizeZoom = function (ui) {}
...
/**
 * 获取Network的bounds
 * @method twaver.vector.Network.getUnionBounds
 * @return {Object} 矩形范围
 */
twaver.vector.Network.prototype.getUnionBounds = function () {}
 ...
 * @param {twaver.Data} data 数据对象
 * @return {Object} 视图范围，是一个包含x、y、witch和height值的对象
 */
 ...
 */
twaver.vector.Network.prototype.handleElementBoxPropertyChange = function () {}
 ...
 * @param {Object} c 网元顺序变化事件，包含element、oldIndex和newIndex属性
 */
twaver.vector.Network.prototype.handleIndexChange = function (c) {}

/**
 * ElementBox的LayerBox里Layer添加、删除以及清空时的处理函数，用户不需要调用此方法，但可以重载此方法，添加自定义逻辑
 * @method twaver.vector.Network.handleLayerBoxChange
 */
twaver.vector.Network.prototype.handleLayerBoxChange = function () {}

/**
 * ElementBox的LayerBox里Layer层次变化时的处理函数，用户不需要调用此方法，但可以重载此方法，添加自定义逻辑
 * @method twaver.vector.Network.handleLayerHierarchyChange
 */
twaver.vector.Network.prototype.handleLayerHierarchyChange = function () {}
 ...
 * @return {Object} 返回鼠标下或指定坐标下的网元视图对象或附件对象
 */
twaver.vector.Network.prototype.hitTest = function (e) {}
...
/**
 * 是否异步缩放视图尺寸与视图区域
 * @method twaver.vector.Network.isAsyncZoomAndViewRect
 * @return {Boolean} true则视区不随缩放变化，false则视区大小虽缩放同步变化
 */
twaver.vector.Network.prototype.isAsyncZoomAndViewRect = function () {}
...
/**
 * 获取是否已开启Debug模式
 * @method twaver.vector.Network.isDebug
 * @return {Boolean} 是否已开启Debug模式
 */
twaver.vector.Network.prototype.isDebug = function () {}
...
/**
 * 判断是否可以通过拖拽实现Pan的功能
 * @method twaver.vector.Network.isDragToPan
 * @return {Boolean} 拖动是否可以Pan
 */
twaver.vector.Network.prototype.isDragToPan = function () {}

/**
 * 是否启动边缘检测功能
 * @method twaver.vector.Network.isEdgeDetect
 * @return {Boolean} 边缘检测
 */
twaver.vector.Network.prototype.isEdgeDetect = function () {}
 ...
 * @return {Boolean} 返回指定节点是否可以创建连线
 */
twaver.vector.Network.prototype.isLinkable = function (node, fromNode) {}
...
/**
 * 获取Zoom或Pan的时候Attachments是否需要绘制，默认为true
 * @method twaver.vector.Network.isShowAttachmentsInZoomOrPan
 * @return {Boolean} 返回在Zoom或Pan的时候Attachments是否绘制
 */
twaver.vector.Network.prototype.isShowAttachmentsInZoomOrPan = function () {}

/**
 * 判断在zoom、Pan、Autolayout情况下是否绘制附件，默认为true
 * @method twaver.vector.Network.isShowAttachmentsInZoomPanOrAutoLayout
 * @return {Boolean} 返回在zoom、Pan、Autolayout情况下是否绘制附件
 */
twaver.vector.Network.prototype.isShowAttachmentsInZoomPanOrAutoLayout = function () {}
...
/**
 * 获取是否在编辑状态显示阴影
 * @method twaver.vector.Network.isShowShadowInEdit
 * @return {Boolean} 是否在编辑状态显示阴影
 */
twaver.vector.Network.prototype.isShowShadowInEdit = function () {}
...
/**
 * 获取当前附件是否需要显示
 * @method twaver.vector.Network.isVisibleAttachment
 * @param {twaver.vector.Attachment} data 附件
 * @return {Boolean} 是否显示
 */
twaver.vector.Network.prototype.isVisibleAttachment = function (data) {}
...
/**
 * 将所有网元移动到中心点
 * @method twaver.vector.Network.moveElementsToCenter
 */
twaver.vector.Network.prototype.moveElementsToCenter = function () {}
...
/**
 * 单击背景鼠标监听事件
 * @method twaver.vector.Network.onClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onClickBackground = function (e) {}

/**
 * 点击网元鼠标监听事件
 * @method twaver.vector.Network.onClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onClickElement = function (element, e) {}

/**
 * 双击背景鼠标监听事件
 * @method twaver.vector.Network.onDoubleClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onDoubleClickBackground = function (e) {}

/**
 * 双击网元鼠标监听事件
 * @method twaver.vector.Network.onDoubleClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onDoubleClickElement = function (element, e) {}

/**
 * 长按背景鼠标监听事件
 * @method twaver.vector.Network.onLongClickBackground
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onLongClickBackground = function (e) {}

/**
 * 长按网元鼠标监听事件
 * @method twaver.vector.Network.onLongClickElement
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onLongClickElement = function (element, e) {}

/**
 * 鼠标进入监听事件
 * @method twaver.vector.Network.onMouseEnter
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onMouseEnter = function (element, e) {}

/**
 * 鼠标离开监听事件
 * @method twaver.vector.Network.onMouseLeave
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onMouseLeave = function (element, e) {}

/**
 * 鼠标移动监听事件
 * @method twaver.vector.Network.onMouseMove
 * @param {twaver.Element} element 网元
 * @param {MouseEvent} e 鼠标事件
 */
twaver.vector.Network.prototype.onMouseMove = function (element, e) {}
 ...
 * @param {CanvasRenderingContext2D} ctx 画布上下文
 * @param {String} dirtyRect 
 */
twaver.vector.Network.prototype.paintBottom = function (ctx, dirtyRect) {}
 ...
 * @param {String} dirtyRect 
 */
twaver.vector.Network.prototype.paintRoot = function (dirtyRect) {}

/**
 * 根据污染范围，绘制最上层元素
 * @method twaver.vector.Network.paintTop
 * @param {String} ctx Canvas上下文
 * @param {Object} dirtyRect 污染范围
 */
twaver.vector.Network.prototype.paintTop = function (ctx, dirtyRect) {}
...
/**
 * 设置不同子网之间的缩放zoom值是否同步
 * @method twaver.vector.Network.setAsyncZoomAndViewRect
 * @param {Boolean} v 是否异步，默认为false
 */
twaver.vector.Network.prototype.setAsyncZoomAndViewRect = function (v) {}
...
/**
 * 设置开启Debug模式
 * @method twaver.vector.Network.setDebug
 * @param {Boolean} v 是否开启debug模式
 */
twaver.vector.Network.prototype.setDebug = function (v) {}
...
/**
 * 设置Network画布的交互模式，true为拖拽模式，false为框选模式
 * @method twaver.vector.Network.setDragToPan
 * @param {Boolean} v Network画布是否可以拖拽，默认为true
 * @example network.setDragToPan(false);
 */
twaver.vector.Network.prototype.setDragToPan = function (v) {}

/**
 * @method twaver.vector.Network.setEdgeDetect
 * @param {Boolean} v 是否启动边缘检测，默认为false
 */
twaver.vector.Network.prototype.setEdgeDetect = function (v) {}
...
/**
 * 设置放大镜交互模式
 * @method twaver.vector.Network.setMagnifyInteractions
 */
twaver.vector.Network.prototype.setMagnifyInteractions = function () {}
...
/**
 * 设置选择公差，进入公差范围内即可选中网元
 * @method twaver.vector.Network.setSelectionTolerance
 * @param {Number} v 选择公差值
 */
twaver.vector.Network.prototype.setSelectionTolerance = function (v) {}
...
/**
 * 设置在Zoom或Pan情况下附件是否显示，默认为false,如果设为true，有利于提高渲染性能
 * @method twaver.vector.Network.setShowAttachmentsInZoomOrPan
 * @param {Boolean} v 设置在Zoom或Pan情况下附件是否显示
 * @example network.setShowAttachmentsInZoomOrPan(true);
 */
twaver.vector.Network.prototype.setShowAttachmentsInZoomOrPan = function (v) {}

/**
 * 设置在zoom、Pan、Autolayout情况下是否绘制附件，默认为true,如果设置为false,有利于提高渲染效率
 * @method twaver.vector.Network.setShowAttachmentsInZoomPanOrAutoLayout
 * @param {Boolean} v 设置在zoom、Pan、Autolayout情况下是否绘制附件
 * @example network.setShowAttachmentsInZoomPanOrAutolayout(false);
 */
twaver.vector.Network.prototype.setShowAttachmentsInZoomPanOrAutoLayout = function (v) {}
...
/**
 * 设置编辑状态是否显示阴影
 * @method twaver.vector.Network.setShowShadowInEdit
 * @param {Boolean} v 编辑状态下是否显示阴影
 */
twaver.vector.Network.prototype.setShowShadowInEdit = function (v) {}
 ...
 * @return {HTMLCanvasElement} 返回Canvas元素
 */
twaver.vector.Network.prototype.toCanvas = function (w, h, c, zoom, dx, dy) {}
...
/**
 * 编辑器渲染结束之后调用此方法
 * @method twaver.controls.TableBase.onEditorRendered
 * @param {String} params 
 */
twaver.controls.TableBase.prototype.onEditorRendered = function (params) {}
...
/**
 * 用于过滤渲染编辑器
 * @method twaver.controls.TableBase.renderEditor
 * @param {String} params 
 */
twaver.controls.TableBase.prototype.renderEditor = function (params) {}
...
/**
 * 获取连线透明度
 * @method twaver.controls.Tree.getLineAlpha
 * @return {Number} 透明度
 */
twaver.controls.Tree.prototype.getLineAlpha = function () {}

/**
 * 获取连线颜色
 * @method twaver.controls.Tree.getLineColor
 * @return {Number} 连线颜色
 */
twaver.controls.Tree.prototype.getLineColor = function () {}

/**
 * 获取连线样式
 * @method twaver.controls.Tree.getLineDash
 * @return {String} 连线样式
 */
twaver.controls.Tree.prototype.getLineDash = function () {}

/**
 * 获取连线厚度
 * @method twaver.controls.Tree.getLineThickness
 * @return {Number} 连线厚度
 */
twaver.controls.Tree.prototype.getLineThickness = function () {}
 ...
 * @method twaver.controls.Tree.getLineType
 * @return {String} 连线类型
 */
twaver.controls.Tree.prototype.getLineType = function () {}
 ...
 * @method twaver.controls.Tree.onToggleImageRendered
 * @param {twaver.ImageAsset} image 图片
 */
twaver.controls.Tree.prototype.onToggleImageRendered = function (image) {}
...
/**
 * 设置联系透明度
 * @method twaver.controls.Tree.setLineAlpha
 * @param {Number} v 连线透明度
 */
twaver.controls.Tree.prototype.setLineAlpha = function (v) {}

/**
 * 设置连线颜色
 * @method twaver.controls.Tree.setLineColor
 * @param {Number} v 连线颜色值
 */
twaver.controls.Tree.prototype.setLineColor = function (v) {}

/**
 * 设置连线样式
 * @method twaver.controls.Tree.setLineDash
 * @param {String} v 连线样式
 */
twaver.controls.Tree.prototype.setLineDash = function (v) {}

/**
 * 设置连线厚度
 * @method twaver.controls.Tree.setLineThickness
 * @param {Number} v 连线厚度值
 */
twaver.controls.Tree.prototype.setLineThickness = function (v) {}

/**
 * 设置连线类型
 * @method twaver.controls.Tree.setLineType
 * @param {String} v 连线类型
 */
twaver.controls.Tree.prototype.setLineType = function (v) {}
 ...
 * @return {twaver.ShapeLinkSubNetwork} 折线子网连线
 */
twaver.ShapeLinkSubNetwork = function () {}

twaver.ShapeLinkSubNetwork.prototype = new twaver.ShapeLink()
 ...
 * @type Boolean
 */
twaver.ShapeLinkSubNetwork.prototype.ISubNetwork = function () {}
 ...
 * @param {String} newPoints 
 */
twaver.ShapeNode.prototype.firePointsChange = function (oldPoints, newPoints) {}
 ...
 * @param {twaver.List} value 多边形节点上连线段的集合
 */
twaver.ShapeNode.prototype.setSegments = function (value) {}
...
/**
 * 获取线的透明度
 * @method twaver.controls.TreeTable.getLineAlpha
 * @return {Number} 透明度
 */
twaver.controls.TreeTable.prototype.getLineAlpha = function () {}

/**
 * 获取线的颜色
 * @method twaver.controls.TreeTable.getLineColor
 * @return {String} 颜色
 */
twaver.controls.TreeTable.prototype.getLineColor = function () {}

/**
 * 获取线的虚线样式
 * @method twaver.controls.TreeTable.getLineDash
 * @return {String} 虚线
 */
twaver.controls.TreeTable.prototype.getLineDash = function () {}

/**
 * 获取线的厚度
 * @method twaver.controls.TreeTable.getLineThickness
 * @return {String} 厚度
 */
twaver.controls.TreeTable.prototype.getLineThickness = function () {}

/**
 * 获取线的类型
 * @method twaver.controls.TreeTable.getLineType
 * @return {String} 类型
 */
twaver.controls.TreeTable.prototype.getLineType = function () {}
...
/**
 * @method twaver.controls.TreeTable.onToggleImageRendered
 * @param {String} image 
 */
twaver.controls.TreeTable.prototype.onToggleImageRendered = function (image) {}
...
/**
 * 设置线的透明度
 * @method twaver.controls.TreeTable.setLineAlpha
 * @param {Number} v 透明度
 */
twaver.controls.TreeTable.prototype.setLineAlpha = function (v) {}

/**
 * 设置线的颜色
 * @method twaver.controls.TreeTable.setLineColor
 * @param {String} v 颜色
 */
twaver.controls.TreeTable.prototype.setLineColor = function (v) {}

/**
 * 设置线的虚线样式
 * @method twaver.controls.TreeTable.setLineDash
 * @param {String} v 虚线样式
 */
twaver.controls.TreeTable.prototype.setLineDash = function (v) {}

/**
 * 设置线的厚度
 * @method twaver.controls.TreeTable.setLineThickness
 * @param {String} v 厚度
 */
twaver.controls.TreeTable.prototype.setLineThickness = function (v) {}

/**
 * 设置线的样式
 * @method twaver.controls.TreeTable.setLineType
 * @param {String} v 样式
 */
twaver.controls.TreeTable.prototype.setLineType = function (v) {}
